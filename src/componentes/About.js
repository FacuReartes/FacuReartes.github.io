...
const About = forwardRef((props, ref) => {
  return(
    ...
    <div className='about__paragraph'>
      ...
      <p>A mediados de 2021 comence a interesarme por el desarrollo web y empece aprendiendo por mi cuenta HTML y CSS hasta llegar a React y Tailwind. Actualmente sigo aprendiendo mas sobre el desarrollo web mientras continuo con mi carrera de Universidad.</p>
